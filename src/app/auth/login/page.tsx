              ...
              <>
                ...
                >
                  <div className="rounded-lg border border-dashed border-amber-300 bg-amber-50 px-3 py-2 text-xs text-amber-700">
                    Dev mode — enter any email to sign in (auto-creates ADMIN user)
                  </div>
                  <input
                    type="email"
                    value={devEmail}
                    ...
                    required
                    className="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-sm focus:border-aqua-500 focus:outline-none"
                  />
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-ocean-900 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-ocean-800"
                  >
                    Sign in as Dev
                  </button>
                </form>
